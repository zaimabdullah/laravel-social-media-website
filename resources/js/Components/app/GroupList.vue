      ...
      <Disclosure v-slot="{ open }">
        <DisclosureButton class="w-full">
          <div class="flex justify-between items-center">
            ...
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="currentColor"
              class="w-6 h-6 ui-open:rotate-90 transition-all" :class="open ? 'rotate-90 transform' : ''">
        ...
        <DisclosurePanel>
          <button @click="showNewGroupModal = true"
            class="text-sm bg-indigo-500 hover:bg-indigo-600 text-white rounded py-1 px-2">new group</button>
          <GroupListItems />
        </DisclosurePanel>
      </Disclosure>
    </div>
